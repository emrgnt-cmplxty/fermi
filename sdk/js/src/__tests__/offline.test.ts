...
test('Payment transaction workflow', async () => {
  ...
  expect(utils.getTransactionDigest(transaction)).toStrictEqual(testData.expectedPaymentDigest)
...
test('Futures deposit workflow', async () => {
  ...
  expect(utils.getTransactionDigest(transaction)).toStrictEqual(testData.expectedAccountDepositDigest)
...
test('Futures withdrawal workflow', async () => {
  ...
  expect(utils.getTransactionDigest(transaction)).toStrictEqual(testData.expectedAccountWithdrawalDigest)
...
test('Futures limit order workflow', async () => {
  ...
  expect(utils.getTransactionDigest(transaction)).toStrictEqual(testData.expectedFuturesLimitOrderDigest)
