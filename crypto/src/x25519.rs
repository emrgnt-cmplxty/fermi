...
//!
//! ```
//! use gdex_crypto::{x25519, Uniform, test_utils::TEST_SEED};
...
//! use gdex_crypto::traits::ValidCryptoMaterialStringExt;
//! # fn main() -> Result<(), gdex_crypto::traits::CryptoMaterialError> {
