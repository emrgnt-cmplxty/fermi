...
// The FermiClient can be used to interact with the basic functionality of any Fermi blockchain.
// These functions include the methods getLatestBlockInfo, getBlockInfo, getBlock, and submitTransaction.
// It is assumed that any Fermi blockchain will have these methods.
export default class FermiClient {
