          ...
          <Tooltip
            content={
              <div className="mr-4 text-xs text-th-fgd-3">
                ...
                <a
                  href={`https://explorer.gdex.fi/address/${mangoAccount?.publicKey?.toString()}`}
                  target="_blank"
                  ...
                  <TrBody key={activity_details.signature}>
                    ...
                    <Td>
                      <a
                        ...
                        href={`https://explorer.gdex.fi/tx/${activity_details.signature}`}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                ...
                return (
                  <TrBody key={signature}>
                    ...
                    <Td>
                      <a
                        className="default-transition flex items-center justify-end text-th-fgd-2"
                        href={`https://explorer.gdex.fi/tx/${signature}`}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <span>{t('view-transaction')}</span>
