...
export async function settleAllPnl(
  ...
  try {
    console.log('calling settleAllPerpPnl')
...
export const settlePnl = async (
  ...
  try {
    console.log('mangoClient.programId=', mangoClient.programId.toString())
    console.log('perpMarket.publicKey=', perpMarket.publicKey)
    const marketIndex = mangoGroup.getPerpMarketIndex(perpMarket.publicKey);
    console.log('marketIndex=', marketIndex)
    const perpMarketInfo = mangoGroup.perpMarkets[marketIndex];
    console.log('perpMarketInfo=', perpMarketInfo)
    console.log('perpMarketInfo.perpMarket=', perpMarketInfo.perpMarket.toString())
    console.log('mangoGroup=', mangoGroup)
    console.log('mangoGroup.publicKey=', mangoGroup.publicKey.toString())
    console.log('mangoGroup.feesVault=', mangoGroup.feesVault.toString())
    console.log('mangoGroup.signerKey=', mangoGroup.signerKey.toString())
    console.log('wallet?.adapter=', wallet?.adapter)
    console.log('wallet?.adapter?._publicKey=', wallet?.adapter?._publicKey.toString())
    ...
    console.log('(this.connection as any)[_rpcEndpoint]=',(mangoClient.connection as any)['_rpcEndpoint'])
...
export default function MarketPosition() {
  ...
  const handleSettlePnl = (perpMarket, perpAccount) => {
    console.log('calling handlesettlepnl...')
    if (wallet) {
      setSettling(true)
