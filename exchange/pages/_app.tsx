...
const PageTitle = () => {
  ...
  const marketTitleString =
    marketConfig && router.pathname == '/'
      ? `${
          oraclePrice
            ? (oraclePrice / 1000).toFixed(getDecimalCount(market?.tickSize)) + ' | '
            : ''
        }${selectedMarketName} - `
      : ''
  ...
  return (
    <Head>
      <title>{marketTitleString}GDEX</title>
    </Head>
  )
}
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content="GDEX" />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta
          name="keywords"
          content="GDEX, Serum, SRM, Serum DEX, DEFI, Decentralized Finance, Decentralised Finance, Crypto, ERC20, Ethereum, Decentralize, Solana, SOL, SPL, Cross-Chain, Trading, Fastest, Fast, SerumBTC, SerumUSD, SRM Tokens, SPL Tokens"
        />
        <meta
          name="description"
          content="GDEX - Decentralised, cross-margin trading up to 10x leverage with lightning speed and near-zero fees."
        />
        <link
        ...
        <meta name="twitter:title" content="GDEX" />
        <meta
          name="twitter:description"
          content="GDEX - Decentralised, cross-margin trading up to 20x leverage with lightning speed and near-zero fees."
        />
        <meta
          name="twitter:image"
          content="https://i.ibb.co/vvkJX2q/banana-Markets.png"
        />
