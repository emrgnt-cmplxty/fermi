...
async function main() {
    ...
    await deployer.sendAccountDepositRequest(/* quantity */ 1_000_000, /* marketAdmin */ deployerPublicKey);

    await deployer.sendFuturesLimitOrderRequest(/* baseAssetId */ 0, /* quoteAssetId */ 1, /* side */ 1, /* price */ 1_000, /* quantity */ 1_000, /* admin */ deployerPublicKey);
