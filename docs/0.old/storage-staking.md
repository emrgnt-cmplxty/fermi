...
Axion's JSON JSON-RPC provides [a way to query this initial setting](/docs/api/rpc#genesis-config) as well as a [a way to query the live config / recent blocks](/docs/api/rpc#protocol-config).
