...
Axion uses a system of [Access Keys](../../../1.concepts/basics/accounts/access-keys.md) to simplify handling accounts.
...
redirected to the wallet and be asked to accept the transaction. This is because, once again, only the `Full Access` key can be used to send Axion.
