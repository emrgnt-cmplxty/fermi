...
use fermi_types::{
    ...
    proto::{BlockRequest, LatestBlockInfoRequest, ValidatorGrpcClient},
    store::RPCStoreHandle, transaction::SignedTransaction
};
// external
...
mod test_json_rpc_listener {
    ...
    use fermi_controller::bank::proto::create_payment_transaction;
