...
import { getWeights } from '@gdexorg/ifm-client'
          ...
          <FlipCardBack>
            <FloatingElement className="fadein-floating-element h-full px-1 md:px-4">
              <div className={`${!connected ? 'blur-sm filter' : ''}`}>
                <button
                  onClick={handleFormChange}
                  className="absolute right-4 flex h-8 w-8 items-center justify-center  bg-th-bkg-3 hover:text-th-primary focus:outline-none"
                >
