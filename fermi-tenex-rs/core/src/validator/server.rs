...
impl ValidatorService {
    /// Spawn all the subsystems run by a fermi valdiator: a consensus node, a fermi valdiator server,
    /// and a consensus listener bridging the consensus node and the fermi valdiator.
...
mod test_validator_server {
    ...
    use fermi_controller::bank::proto::bank_controller_test_functions::generate_signed_test_transaction;
