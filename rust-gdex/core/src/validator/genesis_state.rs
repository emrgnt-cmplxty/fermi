...
pub struct ValidatorGenesisState {
    master_controller: MainController,
    validator_set: Vec<ValidatorInfo>,
}

impl ValidatorGenesisState {
    pub fn new(master_controller: MainController, validator_set: Vec<ValidatorInfo>) -> Self {
        ValidatorGenesisState {
            master_controller,
            validator_set,
        }
    }
    pub fn master_controller(&self) -> &MainController {
...
impl Serialize for ValidatorGenesisState {
        ...
        S: Serializer,
    {
        ...
        #[derive(Serialize)]
        struct RawGenesis<'a> {
            master_controller: &'a MainController,
