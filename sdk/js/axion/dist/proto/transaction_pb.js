...
proto.transaction.SignedTransaction.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(1, f, proto.transaction.Transaction.serializeBinaryToWriter)
  }
...
proto.transaction.Transaction.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(1, f, proto.transaction.Version.serializeBinaryToWriter)
  }
...
proto.transaction.Transaction.prototype.getVersion = function () {
  return /** @type{?proto.transaction.Version} */ (jspb.Message.getWrapperField(this, proto.transaction.Version, 1))
}
...
proto.transaction.Transaction.prototype.getRecentBlockHash_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getRecentBlockHash()))
}
...
proto.transaction.Transaction.prototype.getRecentBlockHash_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getRecentBlockHash()))
}
...
proto.transaction.Transaction.prototype.getRequestBytes_asB64 = function () {
  return /** @type {string} */ (jspb.Message.bytesAsB64(this.getRequestBytes()))
}
...
proto.transaction.Transaction.prototype.getRequestBytes_asU8 = function () {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(this.getRequestBytes()))
}
