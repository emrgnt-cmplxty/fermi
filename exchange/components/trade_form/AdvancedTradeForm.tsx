...
export default function AdvancedTradeForm() {
  ...
  */
  ...
  const canTrade = true//ipAllowed || (market instanceof Market && spotAllowed)
          ...
          <div className={`mt-4 flex`}>
            {canTrade ? (
              <button
                ...
                onClick={onSubmit}
                className={`flex-grow px-6 py-2 font-bold text-white focus:outline-none disabled:cursor-not-allowed disabled:bg-th-bkg-4 disabled:text-th-fgd-4 ${
