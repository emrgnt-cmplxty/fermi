...
//! This module provides definitions of tag types to be used by MIRAI analyzing gdex-crypto.
//! This module gets compiled only if the gdex-crypto is compiled via MIRAI in a debug build.
...
/// This type should only be accessible inside gdex-crypto.
