...
interface ExchangeDataResponseMarketData {
  type: string
...
type ExchangeDataResponseArrayedMarketData =
  PickArrayedObjectFields<ExchangeDataResponseMarketData>
type ExchangeDataResponseNonArrayedMarketData = Pick<
  ExchangeDataResponseMarketData,
  Exclude<
    keyof ExchangeDataResponseMarketData,
    keyof ExchangeDataResponseArrayedMarketData
  >
>
...
type ExchangeDataResponse = {
  ...
  [K in keyof ExchangeDataResponseMarketData]:
    | ExchangeDataResponseMarketData[K]
    | NonNullable<ExchangeDataResponseMarketData[K]>[]
}

function extractField<
  Field extends keyof ExchangeDataResponseNonArrayedMarketData,
>(
  data: ExchangeDataResponse,
  field: Field,
  arrayIndex: number,
): ExchangeDataResponseNonArrayedMarketData[Field]
function extractField<
  Field extends keyof ExchangeDataResponseArrayedMarketData,
>(
  data: ExchangeDataResponse,
  field: Field,
  arrayIndex: number,
  valueIsArray: true,
): ExchangeDataResponseArrayedMarketData[Field]
function extractField<Field extends keyof ExchangeDataResponseMarketData>(
  data: ExchangeDataResponse,
  field: Field,
  arrayIndex: number,
  valueIsArray?: boolean,
): ExchangeDataResponseMarketData[Field] {
  const value: ExchangeDataResponse[keyof ExchangeDataResponseMarketData] =
    data[field]

  if (Array.isArray(value) && (!valueIsArray || Array.isArray(value[0]))) {
    return value[arrayIndex] as ExchangeDataResponseMarketData[Field]
  }

  return value as ExchangeDataResponseMarketData[Field]
}
