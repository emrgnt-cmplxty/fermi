  ...
  return (
    <>
      ...
      >
        ...
        <div>
          {mangoAccount ? (
            <div className="-mt-2 mb-2 relative flex text-xs">
              <a
                className="flex  text-th-fgd-4 hover:text-th-primary"
                href={`https://explorer.gdex.fi/address/${mangoAccount?.publicKey}`}
                target="_blank"
