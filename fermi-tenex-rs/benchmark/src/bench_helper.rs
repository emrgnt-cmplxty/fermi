...
use fermi_types::{
    ...
    transaction::{serialize_protobuf, SignedTransaction},
};
// narwhal
...
impl BenchHelper {
    ...
    pub fn new(primary_keypair: AccountKeyPair) -> Self {
        BenchHelper {
            ...
            // TODO - https://github.com/fermiorg/fermi/issues/157 - avoid hard coding by directly calculating created assets...
            base_asset_id: 1,
            quote_asset_id: 2,
        }
    }
    ...
    // TODO - https://github.com/fermiorg/fermi/issues/157 - Fetch created asset number to build this stack properly.
    ...
    pub async fn fund_accounts(&mut self) {
        ...
        // TODO - https://github.com/fermiorg/fermi/issues/157 - check if this causes failures, if so we need a smarter way to fund accounts as we cannot borrow inside loop below
        let recent_block_hash = self.get_recent_block_digest().await;
