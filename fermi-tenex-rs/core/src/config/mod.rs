...
pub const GDEX_KEYSTORE_FILENAME: &str = "fermi.keystore";
...
const GDEX_DIR: &str = ".fermi";
const GDEX_CONFIG_DIR: &str = "fermi_config";
pub fn fermi_config_dir() -> Result<PathBuf, anyhow::Error> {
