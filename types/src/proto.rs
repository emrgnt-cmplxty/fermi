...
pub use gdex::{
    ...
    BlockInfo as BlockInfoProto, Empty, FaucetAirdropRequest, FaucetAirdropResponse, RelayerGetBlockInfoRequest,
    RelayerGetLatestBlockInfoRequest, RelayerResponse, Transaction as TransactionProto,
};
